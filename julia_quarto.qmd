...
knn_probabilities = ifelse(as.logical(knn_predictions), attr(knn_predictions, "prob"), 1 - attr(knn_predictions, "prob"))
...
```{r}
roc_obj = roc(response = knn_compare$y_true, predictor = knn_compare$y_pred)
# compute auc value
auc_value = auc(roc_obj)

# plot results
plot(roc_obj, main = "ROC curve of KNN")
